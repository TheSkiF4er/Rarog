...
* **Предпочтительный канал:** GitHub Security Advisories (в репозитории `TheSkiF4er/rarog`) — создайте закрытое advisory.
...
* При получении репорта создайте закрытый issue и ссылку на security advisory.
