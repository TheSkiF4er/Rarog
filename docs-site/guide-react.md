...
Пакет `@rarog/react` даёт минимальные React-обёртки над JS-ядром Rarog: `RarogProvider`, `RarogModal`, `RarogOffcanvas`, `RarogDropdown` и hooks `useModal/useOffcanvas/useDropdown`.
