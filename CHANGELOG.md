...
- Обновлён раздел **Utilities** в документации и добавлен примерный блок в `docs/index.html`.
...
### Добавлено
- Docs v2 на базе GitBook/static export:
  ...
  - статическая docs-сборка и конфигурация маршрутов для деплоя на docs-hosting.
