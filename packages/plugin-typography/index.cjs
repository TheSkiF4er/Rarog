...
module.exports = createPlugin({
  ...
  version: "1.0.0",
  description: "Content typography for articles, docs, changelogs and long-form marketing pages.",
  official: true,
...
.prose a:hover { color: var(--rarog-color-primary-600); }
.prose ul,
.prose ol { padding-left: 1.5em; margin-top: 0.75em; margin-bottom: 0.75em; }
...
.prose img,
.prose video { margin-top: 1.25em; margin-bottom: 1.25em; border-radius: 0.5rem; }
`;
