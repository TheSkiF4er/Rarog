...
const VERSION = "3.5.0";
module.exports = { Dropdown, Collapse, Modal, Offcanvas, Toast, Tooltip, Popover, Carousel, Stepper, Datepicker, DatetimePicker, Select, Combobox, TagsInput, DataTable, InputMask, Events, initDataApi, init, dispose, reinit, Rarog, VERSION, default: Rarog };
