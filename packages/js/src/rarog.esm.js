/*!
 * Рарог JS Core v1.0.0
 * Vanilla JS вспомогательные классы for interactive Компонентs (dropdown, collapse, modal).
...
/* -------------------------------------------------------------------------- */
/* Event оболочки for existing Компонентs */
/* -------------------------------------------------------------------------- */
...
/* Lifecycle вспомогательные средства */
/* -------------------------------------------------------------------------- */
 ...
 * Эквивалентно установке window.RAROG_DEBUG / Рарог_DEV, но управляется из кода.
 */
  setDebug(value) {
